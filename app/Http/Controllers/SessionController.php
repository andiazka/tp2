...
class SessionController extends Controller
{
    ...
    function login(Request $request)
    {
        ...
        if(Auth::attempt($infologin)){
            return redirect('User')->with('Sukses', 'Berhasil Login');
        }else{
    ...
    function logout(){
        Auth::logout();
        return redirect('sesi')->with('succes', 'Berhasil Logout dari halaman');
    }
    ...
    function create(Request $request)
    {
        ...
        $request->validate([
            ...
            'password.required'=>'Password wajib diisi',
            'password.min'=>'Jumlah Password minimal 10 karakter'
        ]
        );
